-- Migration number: 0001 	 2025-05-26T00:35:36.570Z
CREATE TABLE image_categories (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    slug TEXT UNIQUE,
    display_name TEXT created_at TEXT DEFAULT CURRENT_TIMESTAMP
);
INSERT INTO image_categories (slug, display_name)
...
VALUES (
        1,
        1,
        'https://example.com/some_image.png',
        'Example 1',
        'PNG',
        '600x400',
        1024
    ...
    (
        2,
        3,
        'https://example.com/one_more_image.png',
        'Example 3',
        'PNG',
        '600x400',
        1024
    ...
    (
        3,
        4,
        'https://example.com/last_mage.jpg',
        'Example 4',
        'JPG',
        '600x400',
        1024
